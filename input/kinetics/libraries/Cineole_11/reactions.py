...
entry(
    ...
    label = "R1OO <=> Q1OOH",
    degeneracy = 1,
    kinetics = Arrhenius(A=(2.09e+08, 's^-1'), n=0.785, Ea=(41.305, 'kcal/mol'), T0=(1, 'K')),
    longDesc =
u"""
From BMK/6-311G by Oscar Wu
""",
)
...
entry(
    ...
    label = "Q1OOH <=> R1O + OH",
    degeneracy = 1,
    kinetics = Arrhenius(A=(8.46e+10, 's^-1'), n=0.174, Ea=(55.794, 'kcal/mol'), T0=(1, 'K')),
    longDesc =
u"""
From BMK/6-311G by Oscar Wu
""",
...
entry(
    index = 92,
    label = "R1cycQOOH-1 <=> R1cycQO + OH",
    degeneracy = 1,
    kinetics = Arrhenius(A=(8.04e+07, 's^-1'), n=2.514, Ea=(55.943, 'kcal/mol'), T0=(1, 'K')),
    longDesc =
u"""
From CBS-QB3 by Oscar Wu
""",
...
entry(
    index = 93,
    label = "Q6OOHOOH <=> Q6OOHO + OH",
    degeneracy = 1,
    kinetics = Arrhenius(A=(8.04e+07, 's^-1'), n=2.514, Ea=(55.943, 'kcal/mol'), T0=(1, 'K')),
    longDesc =
u"""
From CBS-QB3
Using the rate for: R1cycQOOH-1 <=> R1cycQO + OH
""",
)
...
Using the rate for: R2OO <=> Q2OOH-3
""",
)
...
u"""
From BMK/6-311G
Using the rate for: R3OO <=> Q3OOH
""",
)

entry(
    index = 96,
    label = "Q4OOH-1 <=> R3O + OH",
    degeneracy = 1,
    kinetics = Arrhenius(A=(9.33e+10, 's^-1'), n=0.287, Ea=(16.8, 'kcal/mol'), T0=(1, 'K')),
    longDesc =
u"""
From BMK/6-311G
Using the rate for: Q3OOH <=> R3O + OH
Note that R3O and R4O are the same species
""",
)

entry(
    index = 97,
    label = "Q4OOHOO-2 <=> Q4OOHOOH-2",
    degeneracy = 1,
    kinetics = Arrhenius(A=(1.90e+06, 's^-1'), n=1.55, Ea=(19.0, 'kcal/mol'), T0=(1, 'K')),
    longDesc =
u"""
...
entry(
    index = 98,
    label = "R1cycC7H11O2 <=> R1cycQO_tone + OH",
    degeneracy = 1,
    kinetics = Arrhenius(A=(1.05e+09, 's^-1'), n=1.355, Ea=(38.85, 'kcal/mol'), T0=(1, 'K')),
    longDesc =
u"""
From Sirjean et al. (2009).
Journal of Physical Chemistry A, 113(25), 6924–6935. https://doi.org/10.1021/jp901492e.
...
entry(
    index = 100,
    label = "R1cycQOOH-1 + O2 <=> R1cycQOOHOO-1",
    degeneracy = 1,
    kinetics = Arrhenius(A=(3.487e+14, 'cm^3/(mol*s)'), n=-0.816, Ea=(-0.536, 'kcal/mol'), T0=(1, 'K')),
    longDesc =
u"""
...
entry(
    index =101,
    label = "R1cycQOOHOO-1 <=>  R1cycQOOHOOH-1",
    degeneracy = 1,
    kinetics = Arrhenius(A=(1.82e+07, 's^-1'), n=1.668, Ea=(25.10, 'kcal/mol'), T0=(1, 'K')),
    longDesc =
u"""
From Sirjean et al. (2009).
Journal of Physical Chemistry A, 113(25), 6924–6935. https://doi.org/10.1021/jp901492e.
...
entry(
    index =102,
    label = "R1cycQOOHOOH-1 <=>  R1cycQOOHO-1 + OH",
    degeneracy = 1,
    kinetics = Arrhenius(A=(1.0e+09, 's^-1'), n=0.00, Ea=(39.2, 'kcal/mol'), T0=(1, 'K')),
    longDesc =
u"""
From Sirjean et al. (2009).
Journal of Physical Chemistry A, 113(25), 6924–6935. https://doi.org/10.1021/jp901492e.
Rxn 1 -> 6. Only Ea is known, so A and n were chosen arbitrarily. Because Ea is too high, A and n do not matter.
""",
)

entry(
    index = 103,
    label = "R1cycQOOH-2 + O2 <=> R1cycQOOHOO-2",
    degeneracy = 1,
    kinetics = Arrhenius(A=(3.487e+14, 'cm^3/(mol*s)'), n=-0.816, Ea=(-0.536, 'kcal/mol'), T0=(1, 'K')),
    longDesc =
u"""
...
entry(
    index =104,
    label = "R1cycQOOHOO-2 <=>  R1cycQOOHOOH-2",
    degeneracy = 1,
    kinetics = Arrhenius(A=(3.63e+08, 's^-1'), n=1.401, Ea=(31.74, 'kcal/mol'), T0=(1, 'K')),
    longDesc =
u"""
...
entry(
    index =105,
    label = "R1cycQOOHOOH-2 <=>  R1cycQOOHO-2 + OH",
    degeneracy = 1,
    kinetics = Arrhenius(A=(1.0e+09, 's^-1'), n=0.00, Ea=(39.2, 'kcal/mol'), T0=(1, 'K')),
    longDesc =
u"""
...
entry(
    index = 106,
    label = "R1cycC7H11O2 <=> R1fusedcycC7H11O2-b",
    degeneracy = 1,
    kinetics = Arrhenius(A=(1.40e+11, 's^-1'), n=0.26, Ea=(21.5, 'kcal/mol'), T0=(1, 'K')),
    longDesc =
u"""
...
entry(
    index = 109,
    label = "bscisOC7H11O-2b-1 <=> bscisbscisOC7H11O-2b-1a",
    degeneracy = 1,
    kinetics = Arrhenius(A=(4.23e+12, 's^-1'), n=0.07, Ea=(3.9, 'kcal/mol'), T0=(1, 'K')),
    longDesc =
u"""
...
entry(
    index = 110,
    label = "bscisOC7H11O-2b-1 <=> bscisbscisOC7H11O-2b-1b",
    degeneracy = 1,
    kinetics = Arrhenius(A=(6.36e+12, 's^-1'), n=0.12, Ea=(12.2, 'kcal/mol'), T0=(1, 'K')),
    longDesc =
u"""
...
entry(
    ...
    label = "R3OO <=> Q3OOH-3",
    degeneracy = 1,
    kinetics = Arrhenius(A=(2.15e+09, 's^-1'), n=0.765, Ea=(28.6, 'kcal/mol'), T0=(1, 'K')),
    longDesc =
u"""
From BMK/6-311G(2d,d,p)
Using the rate for: R3OO <=> Q3OOH-3
""",
)
...
entry(
    ...
    label = "S171 <=> S1659",
    degeneracy = 1,
    kinetics = Arrhenius(A=(1, 's^-1'), n=1, Ea=(100, 'kcal/mol'), T0=(1, 'K')),
    longDesc =
u"""
Forbidden. For R1 pathway
""",
)

entry(
    index = 202,
    label = "Q3OOH-3 <=> R5O + OH",
    degeneracy = 1,
    kinetics = Arrhenius(A=(1, 's^-1'), n=1, Ea=(100, 'kcal/mol'), T0=(1, 'K')),
    longDesc =
u"""
Forbidden. For R3 pathway
R3O-3 is the same species as R5O
""",
)

entry(
    index = 203,
    label = "cycC7H11-2 <=> C7H11_193",
    degeneracy = 1,
    kinetics = Arrhenius(A=(1, 's^-1'), n=1, Ea=(100, 'kcal/mol'), T0=(1, 'K')),
    longDesc =
u"""
Forbidden. For R4 pathway
""",
)

entry(
    index = 204,
    label = "Q4OOH-2 <=> S1298 + OH",
    degeneracy = 1,
    kinetics = Arrhenius(A=(1, 's^-1'), n=1, Ea=(100, 'kcal/mol'), T0=(1, 'K')),
    longDesc =
u"""
...
entry(
    index = 205,
    label = "Q5OOH-1 <=> R5O + OH",
    degeneracy = 1,
    kinetics = Arrhenius(A=(1, 's^-1'), n=1, Ea=(100, 'kcal/mol'), T0=(1, 'K')),
    longDesc =
u"""
Forbidden. For R5 pathway
""",
)
...
entry(
    index = 207,
    label = "R1cycC7H11O2 <=> R1fusedcycC7H11O2-a",
    degeneracy = 1,
    kinetics = Arrhenius(A=(1, 's^-1'), n=1, Ea=(100, 'kcal/mol'), T0=(1, 'K')),
    longDesc =
u"""
