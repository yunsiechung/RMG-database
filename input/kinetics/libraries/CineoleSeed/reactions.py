...
entry(
    ...
    label = "R2 + O2 <=> R2OO",
    degeneracy = 1,
    kinetics = Arrhenius(A=(2.637e+13, 'cm^3/(mol*s)'), n=-0.129, Ea=(-0.002, 'kcal/mol'), T0=(1, 'K')),
)
...
entry(
    ...
    label = "R3 + O2 <=> R3OO",
    degeneracy = 1,
    kinetics = Arrhenius(A=(1.21875e+9, 'cm^3/(mol*s)'), n=-0.99, Ea=(1.33, 'kcal/mol'), T0=(1, 'K')),
)
...
entry(
    ...
    label = "R5 + O2 <=> R5OO",
    degeneracy = 1,
    kinetics = Arrhenius(A=(1.319e+13, 'cm^3/(mol*s)'), n=-0.017, Ea=(-0.262, 'kcal/mol'), T0=(1, 'K')),
)